      ...
      <div class="card p-6">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          <div>
            ...
            <input v-model="form.email" type="email" class="input" placeholder="tu@email.com" required autocomplete="username" />
          </div>
          <div>
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
          ¿Sos inquilino o propietario?
          <RouterLink to="/portal" class="text-primary-600 font-medium hover:underline ml-1">Ingresá al portal</RouterLink>
        </p>
      </div>
    </div>
  </div>
